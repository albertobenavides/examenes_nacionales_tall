...
class TemaPolicy
{
    ...
    {
        return $user->can('delete_any_tema');
    }
    ...
    {
        return $user->can('force_delete_any_tema');
    }
    ...
    {
        return $user->can('restore_any_tema');
    }
     ...
     * @return bool
     */
    public function replicate(User $user, Tema $tema): bool
    {
        return $user->can('replicate_tema');
    }
