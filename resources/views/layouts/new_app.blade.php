    ...
    <div class="navbar">
        ...
        <div class="navbar-center">
            <label class="input input-bordered flex items-center gap-2">
                ...
                <input type="text" class="grow" placeholder="Buscar... Próximamente" disabled/>
            </label>
            @auth
                <a href="/cursos" class="btn btn-ghost text-xl">Mis cursos</a>
            @endauth
        </div>
