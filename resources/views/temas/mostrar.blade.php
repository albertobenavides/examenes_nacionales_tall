                ...
                @if ($tema->contenido != null)
                    @for ($i = 0; $i < count($tema->contenido); $i++)
                        <div>
                            ...
                            <iframe src = "{{ '/ViewerJS/index.html#../descargar/' . $tema->contenido[$i]['data']['pdf'] . '?curso_id= $modulo->curso->id ' }}'}}" style="height:80vh; width:100%" allowfullscreen webkitallowfullscreen></iframe>
